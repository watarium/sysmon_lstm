...
# learning data
data = pd.read_csv("noise_gutenberg.csv")
token_data = 'noise_gutenberg_token.pickle'
encode_data = 'noise_gutenberg_encode.pickle'
model_data = 'noise_gutenberg_model.h5'
